...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    cube_result = volume_of_a_cube(5)
    assert_equal(125, cube_result)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    sphere_result = volume_of_a_sphere(10)
    assert_equal(4187.743007235194, sphere_result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    conversion_result = fahrenheit_to_celsius(145)
    assert_equal(62, conversion_result)
  end
